...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Patiently hoping for a Degree, Year 1 PhD student in HKUST(GZ), Approximation Algorithms on Graphs, Welcome to my Blog',
